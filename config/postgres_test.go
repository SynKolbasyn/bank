...
func TestLoadPostgres(t *testing.T) {
	testData := []struct{
		...
		{"localhost", "5432", "user", "password", "database", "postgres://user:password@localhost:5432/database"},
		{"localhost", "5432", "user", "pass:word", "database", "postgres://user:pass%3Aword@localhost:5432/database"},
		{"localhost", "5432", "us:er", "password", "database", "postgres://us%3Aer:password@localhost:5432/database"},
